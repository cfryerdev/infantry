...
const Footer = () => {
  return (
    <footer className="text-center text-muted m-4">
        <hr />
        <a href="https://github.com/infantryio/report-viewer" target="blank" className="text-muted ml-1 mr-1">
            <i className="fab fa-github-square fa-2x"></i>
        </a>
        <a href="https://twitter.com/infantryio?lang=en" target="blank" className="text-muted ml-1 mr-1">
            <i className="fab fa-twitter-square fa-2x"></i>
        </a>
        <a href={`mailto:${packageJson.email}`} target="blank" className="text-muted ml-1 mr-1">
            <i className="fas fa-envelope-square fa-2x"></i>
        </a>
        <a href="https://infantry.io" target="blank" className="text-muted ml-1 mr-1">
            <i className="fas fa-external-link-square-alt fa-2x"></i>
        </a>
        <br />
        <small className="text-muted version">Infantry.io © 2021. All rights reserved.</small>
        <br />
